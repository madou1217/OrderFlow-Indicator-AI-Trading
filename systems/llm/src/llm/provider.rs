    ...
    json!({
        ...
        "properties": {
            ...
            "cross_timeframe_parse": {
                "type": "object",
                "additionalProperties": false,
                "required": ["shared_levels", "execution_alignment_15m", "main_tension", "unresolved_factors"],
                "properties": {
                    "shared_levels": {
                        "type": "array",
                        "maxItems": 6,
  ...
  "reason": "x"
    ...
    fn qwen_scan_output_contract_matches_scan_schema_shape() {
        for prompt_template in ["big_opportunity", "medium_large_opportunity"] {
            ...
            assert!(contract.contains(
                "`shared_levels`, `execution_alignment_15m`, `main_tension`, and `unresolved_factors`"
            ));
