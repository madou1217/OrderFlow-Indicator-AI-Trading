...
pub async fn bootstrap() -> Result<AppContext> {
    ...
    debug!(
        ...
        workflow_stage1_refresh_mins = ?config.llm.workflow.stage1_refresh_mins,
        workflow_stage1_no_edge_retry_minutes = ?config.llm.workflow.stage1_no_edge_retry_minutes,
