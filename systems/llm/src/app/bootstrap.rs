...
pub async fn bootstrap() -> Result<AppContext> {
    ...
    debug!(
        ...
        workflow_enabled = config.llm.workflow.enabled,
        workflow_stage1_refresh_hours = ?config.llm.workflow.stage1_refresh_hours,
        workflow_stage2_refresh_minutes = ?config.llm.workflow.stage2_refresh_minutes,
        workflow_soft_gate_a_continuation = config.llm.workflow.soft_gate_min_pass.a_continuation,
        workflow_soft_gate_b_reversal = config.llm.workflow.soft_gate_min_pass.b_reversal,
        workflow_soft_gate_c_value_return = config.llm.workflow.soft_gate_min_pass.c_value_return,
        workflow_state_dir = %config.llm.workflow.state_dir,
        workflow_persist_prompt_inputs = config.llm.workflow.persist_prompt_inputs,
        ...
        compatibility_entry_sl_remap_enabled = config.llm.compatibility.execution_policy.entry_sl_remap.enabled,
        compatibility_entry_to_sl_distance_pct = config.llm.compatibility.execution_policy.entry_sl_remap.entry_to_sl_distance_pct,
        compatibility_min_distance_v = config.llm.compatibility.execution_policy.min_distance_v,
        compatibility_min_rr = config.llm.compatibility.execution_policy.min_rr,
